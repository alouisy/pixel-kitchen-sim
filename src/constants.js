...
export const CATALOG_ITEMS = [
    ...
    { name: "Coating Station", type: STATION_TYPES.PROCESSOR, category: "Stations", size: { width: 0.5, depth: 0.5 }, color: "#DEB887", config: { processes: ["raw_chicken_strips", "onion_rings_raw"], result: { "raw_chicken_strips": "coated_chicken_strips", "onion_rings_raw": "onion_rings_coated" }, processingTime: 2000 } },
    ...
    { name: "Cheeseburger Combo", type: STATION_TYPES.PREPLACED_ITEM, category: "Dishes", size: { width: 0.5, depth: 0.5 }, config: { item: "plate", contents: ["bun", "cheese_slice", "cooked_fries", "cooked_patty"] } },
    ...
    { name: "Chicken Tenders & Fries", type: STATION_TYPES.PREPLACED_ITEM, category: "Dishes", size: { width: 0.5, depth: 0.5 }, config: { item: "plate", contents: ["cooked_chicken_tenders", "cooked_fries"] } },
