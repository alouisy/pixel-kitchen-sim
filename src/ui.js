...
export class UIManager {
    ...
    setLanguage(lang) {
        ...
        const volumeLabel = this.settingsScreen.querySelector('label[for="volume-setting"]'); if (volumeLabel) volumeLabel.textContent = this.uiText[lang].masterVolume;
        const sensLabel = this.settingsScreen.querySelector('label[for="sensitivity-setting"]'); if (sensLabel) sensLabel.textContent = this.uiText[lang].mouseSensitivity;
        const mobLookLabel = this.settingsScreen.querySelector('label[for="mobile-look-sens-setting"]'); if (mobLookLabel) mobLookLabel.textContent = this.uiText[lang].mobileCameraSens;
